...
RANDOM_STATE = 42
IMAGES_DIR = "C:\\Users\\Anamika S Nair\\Downloads\\Fruit Dataset"  # Path to the images folder
...
print(len(X_images_extended), len(y_labels_extended), len(y_calories_extended))
